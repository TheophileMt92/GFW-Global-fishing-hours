...
# 1. Combining AIS and Sentinel-1 SAR fishing effort data from Global Fishing Watch at a 0.1 Degree resolution
...
## AIS data (2017-2020)
Data from Kroodsma et al. (2018) Science, accessible at: https://globalfishingwatch.org/data-download/datasets/public-fishing-effort 
The data is accessible up to the end of the year 2020. 
...
Data from Paolo et al. 2024 Nature, accessible at: https://globalfishingwatch.org/data-download/datasets/public-sar-vessel-detections:v20231026 The data is accessible from 2017 to today, we used four entire years of data (2017,2018,2019,2020) to match AIS records. 
...
## Random forest model
Predicting fishing hours in areas with only SAR data at 0.1 degree resolution. Using a random forest model of >160,000 associations between SAR vessel detections and AIS fishing hours globally. 
```{r}
